...
// Array de escolas extraído e ajustado
const escolasJoinville =  [
    "Caic Professor Mariano Costa",
    "Caic Prof Desemb Francisco José R de Oliveira",
    "Centro de Educação Infantil Alegria de Viver",
    "Centro de Educação Infantil Amandos Finder",
    "Centro de Educação Infantil Antônio Bruhmuller",
    "Centro de Educação Infantil Aventuras de Crianca",
    ...
    "Centro de Educação Infantil Justina Rosa Fachini",
    ...
    "Centro de Educação Infantil Vice Prefeito Ivan Rodrigues",
    ...
    "Centro de Educação Infantil Botãozinho de Rosa",
    ...
    "Centro de Educação Infantil Espaco da Crianca",
    ...
    "Centro de Educação Infantil Fátima",
    ...
    "Centro de Educação Infantil Mário Avancini",
    "Centro de Educação Infantil Miosótis",
    "Centro de Educação Infantil Morro do Meio",
    "Centro de Educação Infantil Mundo Azul",
    "Centro de Educação Infantil Odorico Fortunato",
    "Centro de Educação Infantil Pão de Mel",
    "Centro de Educação Infantil Paraiso da Crianca",
    ...
    "Centro de Educação Infantil Professora Zelândia Thomazi Bratti",
    "Centro de Educação Infantil Raio de Sol",
    "Centro de Educação Infantil Sementinha",
    "Centro de Educação Infantil Sol Nascente",
    "Centro de Educação Infantil Sonho de Crianca",
    "Centro de Educação Infantil Zé Carioca",
    ...
    "Escola Municipal Nove de Março",
    ...
    "Escola Municipal Pres Arthur da Costa e Silva",
    "Escola Municipal Presidente Castello Branco",
    "Escola Municipal Professor Ada Sant'anna da Silveira",
    ...
    "Escola Municipal Professor Honório Saldo",
    "Escola Municipal Professor João Meerholz",
    "Escola Municipal Professor José Motta Pires",
    "Escola Municipal Professor Júlio Machado da Luz",
    ...
    "Centro de Educação Infantil Kairós Kids",
    "Centro de Educação Infantil Le Juju",
    "Centro de Educação Infantil Luana Cristie",
    "Centro de Educação Infantil Mamãe Coruja",
    "Centro de Educação Infantil Maria Ofélia Guimarães",
    ...
    "Centro de Educação Infantil Pequeno Céu Me",
    ...
    "Centro de Educação Infantil Príncipe da Paz",
    ...
    "Centro de Educação Infantil Zig Alu Escola",
    ...
    "Centro de Educação Infantil da Associação Acolher Jardim Paraíso",
    "Centro de Educação Infantil Eccher e Budal Arins",
    "Centro de Educação Infantil Tia Sula Unidade Ii",
    "Centro de Educacao Infantil Estação das Cores Em",
    ...
    "Centro de Ensino Grau Técnico - Joinville - Sc",
    "Centro Educ Conde Modesto Leal",
    "Centro Educ Dia Feliz",
    "Centro Educacional Católica Machado de Assis",
    "Centro Educacional Conexao",
    "Centro Educacional Mãe Natureza",
    ...
    "Colégio Evangélico Pr Manoel Germano de Miranda",
    "Colégio Exathum",
    "Colégio Oficina",
    ...
    "Doce Mel Recreação e Educação Infantil",
    ...
    "Escola Mais",
    "Escola Nova Geracao",
    "Escola Proeza do Saber",
    "Escola Querubim",
    "Escola Relicário de Luz",
    "Escola Riscos e Rabiscos",
    "Escola SESI de Referência Joinville",
    "Escola Técnica Advance Internacional",
    "Escola Técnica Tupy",
    "Escola Vida Nova",
    "Exathum Curso e Colégio",
    "Fundacao Pro-rim - Ipreps",
    "Gasp Grupo de Assistência Social Paraíso",
    "Ibdi Escola de Formação Profissional",
    ...
    "Instituto Referência Em Educação Integrada",
    "Instituto Tecnológico Assessoritec",
    "Jardim de Infância Curupira",
    "Jardim de Infância e Educação Bilíngue Curupira - Curupira Educação Bilíngue",
    "Jardim de Infância Leãozinho",
    "Senac de Joinville",
    "Senai Sc - Joinville Norte I",
    "Senai Sc - Joinville Sul",
    "Serviço Social do Comércio",
    "Sesi Sc - Joinville Norte",
    ...
    "Eeb Professor Gertrudes Benta Costa",
    ...
    "Eem Bailarina Lieselotte Trinks",
    "Eem Dep Nagib Zattar",
    "Eem Gov Celso Ramos",
    "Eem Governador Luiz Henrique da Silveira",
    "Ud Penitenciária Ind Jucemar Cesconetto Jlle",
    "Ud Presídio Feminino de Joinville",
    "Ud Presídio Regional de Joinville",
    "Ud Quilombola Beco do Caminho Curto"
  ]


// Ordenar o array de escolas em ordem alfabética
const escolasOrdenadas = escolasJoinville.sort();

export async function escolaRoutes(fastify: FastifyInstance) {
  // Endpoint GET para retornar todas as escolas organizadas
  fastify.get('/joinville', async (request, reply) => {
    try {
      reply.send(escolasOrdenadas);
    } catch (error) {
      reply.code(500).send({ error: 'Erro ao buscar escolas.' });
    }
  });

  // Endpoint GET para pesquisar escolas
  fastify.get('/joinville/search', async (request, reply) => {
    try {
      // Obtém o parâmetro de busca da query
      const { q } = request.query as { q?: string };

      if (!q) {
        return reply.send(escolasOrdenadas);
      }
      ...
      // Filtra as escolas que correspondem ao termo de busca
      const escolasFiltradas = escolasOrdenadas.filter(escola => {
        const normalizedEscola = escola.toLowerCase()
          .normalize('NFD')
          .replace(/[\u0300-\u036f]/g, '');
        
        return normalizedEscola.includes(normalizedSearch);
      });

      reply.send(escolasFiltradas);
    } catch (error) {
      reply.code(500).send({ error: 'Erro ao pesquisar escolas.' });
    }
  });
}