    ...
    <div className="flex flex-col md:flex-row w-full min-h-screen">
      ...
      <div className="w-full md:w-3/6 md:h-[840px] flex flex-col items-center justify-center px-4 py-8 md:py-0">
        <div className="w-full md:w-10/12 px-4">
          <h1 className="text-[#003966] mb-4 font-bold text-2xl sm:text-3xl md:text-5xl">
            Esqueceu a Senha?
          </h1>
          <h3 className="text-neutral-400 text-xs sm:text-sm md:text-base mt-2 mb-6">
            Siga os passos para recuperar sua conta
          </h3>
          <FormularioForgot />
          <div className="mt-4 w-full text-center text-[#003966] md:mt-7 font-medium underline decoration-[#003966] relative">
            <Link href={"./cadastro"}>
              <p className="text-sm md:text-base">Voltar</p>
            </Link>
          </div>
        </div>
      </div>
