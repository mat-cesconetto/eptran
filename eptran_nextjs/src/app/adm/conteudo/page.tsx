...
export default function Conteudo() {
    ...
    <main>
        ...
        <div className="flex">
            ...
            <Image className="bg-darkBlue-500 rounded-lg h-14 w-14 ml-80 mt-40" src="../Image/livro.png" alt=""/>
            ...
            <div className="grid grid-cols-7">
                ...
                <div className="w-72">
                    ...
                    <button className="font-semibold w-56 h-10 mt-1 shadow-xl flex items-center bg-darkBlue-500 text-white  px-5 rounded-md">
                        <Image className="w-7 mr-3" src="../Image/circulo.png" alt="Adicionar"/>
                        Adicionar Material
                      </button>
            ...
            <div className="w-full rounded-xl mt-16">
                ...
                <div className="flex justify-between">
                    ...
                    <div className="rounded-xl w-48 bg-darkBlue-500">
                        ...
                        <Image className="border rounded-t-xl" src="../Image/mat1.png" alt=""/>
                        ...
                        <div className="flex">
                            ...
                            <button className="cursor-pointer">
                                ...
                                <Image className="w-8 mt-2 ml-3" src="../Image/pontinhos.png" alt=""/>
